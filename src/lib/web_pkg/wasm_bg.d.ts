...
export function transactionbuilder_add_basic_issue_asset_with_tracking(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number): number;
export function transactionbuilder_add_basic_issue_asset_without_tracking(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): number;
