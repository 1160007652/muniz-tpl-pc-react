...
const enUS = {
  ...
  policy: 'Policy',
  traceable: 'Traceable',
  traceable_tips: 'If traceable, the issuer (you) can view all subsequent transactions of the asset.',
  transferable: 'Transferable',
  transferable_tips: 'Non-transferable assets can only be transferred once from the issuer to another user.',
  updatable: 'Updatable',
  ...
  asset_name_create_customize_notice:
    'The nickname is only visible to you and anyone you share your nickname file with.',
  ...
  nickname_repeat_tips_info: 'Conflicting nicknames found. Please use the drop-down box to make selections.',
